...
import store.wetools.api.been.spider.zhihu.ZhihuUser;
import store.wetools.api.service.spider.zhihu.ZhihuUserService;
...
public class ZhiHuUserPageProcessor implements PageProcessor{
    ...
    public void process(Page page) {
        ...
        //2. 如果是用户详细页面
            ...
            zhihuUserService.saveUser(user);//保存用户信息到数据库
        }
    }
